        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    ...
                    <a class="text-body mr-3" href="/Pages/contact.php">İletişim</a>
                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="admin/index.php"><button class="dropdown-item"  type="button">Giriş Yap</button><a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">Taner</span>
            ...
            <div class="col-lg-4 col-6 text-left">
                <form action="index.php?id=4" method="post">
                    <div class="input-group">
                        <input type="text" class="form-control" name="fname" placeholder="Ürünlerimizi Keşfet">
            ...
            <div class="col-lg-4 col-6 text-right">
                ...
                <h5 class="m-0">+90 538 286 42 79</h5>
            </div>
        </div>
    </div>
    <!-- Topbar End -->
